  ...
  function AlterarDados() {
    ...
    if (nome.length === 0) {
      ...
      setMsg('Favor preencher o campo E-mail.');
        ...
        db.collection('fornecedores').doc(props.match.params.id).update({
          nome: nome,
          email: email,
          telefone: telefone,
          cpf: cpf,
