...
function Editar(props) {
  ...
  useEffect(() => {
    firebase.firestore().collection('produtos').doc(props.match.params.id).get().then((resultado) => {
      setNome(resultado.data().nome);
      setCategoria(resultado.data().categoria);
      setCodReferencia(resultado.data().cod_referencia);
      setCodFornecedor(resultado.data().cod_fornecedor);
      setUnidade(resultado.data().unidade);
      setValorCusto(resultado.data().valor_custo);
      setValorUnitario(resultado.data().valor_unitario);
      setEstoqueMinimo(resultado.data().estoque_minimo);
      setEstoqueAtual(resultado.data().estoque_atual);
...
<div className="offset-lg-3 col-lg-6">
  ...
  <form>         
    ...
    <div className="mb-3">
      ...
      <input onChange={e => setCategoria(e.target.value)} value={categoria} type="categoria" className="form-control" id="categoria" />
    </div>
            
    <div className="row">
      <div className="col-sm-6">
        <label htmlFor="telefone" className="form-label">Código Fornecedor</label>
        <input onChange={e => setCodFornecedor(e.target.value)} value={cod_fornecedor} type="text" className="form-control" id="cod_fornecedor" />
      </div>
      <div className="col-sm-6">
        <label htmlFor="cpf" className="form-label">Código Referência</label>
        <input onChange={e => setCodReferencia(e.target.value)} value={cod_referencia} type="text" className="form-control" id="cod_referencia" />
      </div>
    </div>
    ...
    <div className="row">     
      <div className="col-sm-4">
        ...
        <input onChange={e => setUnidade(e.target.value)} value={unidade} type="text" className="form-control" id="unidade" />
      </div>
      <div className="col-sm-4">
        <label htmlFor="cidade" className="form-label">Valor Custo</label>
        <input onChange={e => setValorCusto(e.target.value)} value={valor_custo} type="text" className="form-control" id="valor_custo" />
      </div>
      <div className="col-sm-4">
        <label htmlFor="UF" className="form-label">Valor Unitário</label>
        <input onChange={e => setValorUnitario(e.target.value)} value={valor_unitario} type="text" className="form-control" id="valor_unitario" />
      </div>
    </div>
    ...
    <div className="row">
      <div className="col-sm-6">
        ...
        <input onChange={e => setEstoqueMinimo(e.target.value)} value={estoque_minimo} type="text" className="form-control" id="estoque_minino" />
      </div>
      <div className="col-sm-6">
        <label htmlFor="estoque_atual" className="form-label">Estoque Atual</label>
        <input onChange={e => setEstoqueAtual(e.target.value)} value={estoque_atual} type="text" className="form-control" id="estoque_atual" />
      </div>
    </div>
