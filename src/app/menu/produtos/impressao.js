export class Impressao {
  ...
  CriaCorpoDocumento() {
    const header = [
      ...
      { text: 'Estoque Mínimo', bold: true, fontSize: 9, margin: [0, 4, 0, 0] },
    ...
    const body = this.dadosParaImpressao.map((produto) => {
      return [
        ...
        // { text: produto.categoria, fontSize: 8 },
        { text: produto.unidade, fontSize: 8 },
        { text: produto.estoque_minimo, fontSize: 8 },
        { text: produto.estoque_atual, fontSize: 8 },
      ];
    });
    const lineHeader = [
      {
