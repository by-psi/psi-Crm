  ...
  return (
    <div className="d-flex align-items-center text-center form-container">
      <form className="form-signin">
        <a href="/#">
          <img className="mb-4" src="/imagens/lock.png" alt="" />
        ...
        <button onClick={RegisterNewUser} className="w-100 btn btn-lg btn-primary mt-2" type="button">REGISTRAR CONTA</button>
        {message.length > 0 ? <div className="alert alert-danger mt-2" role="alert">{message}</div> : null}
        {result === 'S' ? <Redirect to='/app/menu/clientes/home' /> : null}
