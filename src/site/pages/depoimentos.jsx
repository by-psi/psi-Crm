        ...
        <div id="carouselExampleInterval" className="carousel slide" data-bs-ride="carousel">
          ...
          <div className="carousel-inner">
            <div className="carousel-item active" data-bs-interval="5000">
              ...
              <p>Excelente ferramenta para administrar seus clientes no dia a dia.</p>
            </div>      
            <div className="carousel-item" data-bs-interval="5000">
              <img src="imagens/afonsomotta.jpg" alt="Afonso Motta"/><br/>
              <em>Afonso Motta - Rio de Janeiro</em>  
              <p>Design simples e elegante, interface intuitiva e agradável para seus usuários.</p>
            </div>     
            <div className="carousel-item" data-bs-interval="5000">
              <img src="imagens/ezequiasmartins.jpg" alt="Ezequias Martins"/><br/>
              <em>Ezequias Martins - Belo Horizonte</em>  
              <p>O PSI CRM tem se revelado uma ferramenta útil e intuitiva.</p>
            </div>     
          </div>
